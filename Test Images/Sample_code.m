...
acsn_009  = ACSN(input1,NA,Lambda,PxSize,'Offset',offset,'Gain',gain,'Mode','Parallel'); % The first time the runtime can be longer if the parallel pool is not already active
figure;
